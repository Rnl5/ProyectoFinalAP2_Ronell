...
@Composable
fun InventarioListScreenProximoVencer(
    ...
    InventarioListBodyProximoVencer(
...
@Composable
fun InventarioListBodyProximoVencer(
    ...
    val filteredProductos by remember(
        ...
        derivedStateOf {
            productos.filter { producto ->
                ...
                val diasHastaVencimiento = ChronoUnit.DAYS.between(hoy, fechaVencimiento)
                val proximoAVencer = diasHastaVencimiento in 0..5

                matchesSearch && matchesCategoria && matchesMarca && proximoAVencer
            }
        }
    }
    ...
    Scaffold(
        topBar = {
            TopAppBar(title = { Text("Productos con Fecha de Vencimiento cercana") },
                actions = {
        ...
        Column(Modifier.padding(padding)) {
            BarraBusquedaFechaExp(searchQuery = searchQuery, onSearchQueryChange = { searchQuery = it })
...
@Composable
fun ProductoItemCompactoFechaExp(
